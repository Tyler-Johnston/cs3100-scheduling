...
public class SchedulerPriority extends Scheduler{
    ...
    Logger logger;
    PriorityQueue<Process> queue = new PriorityQueue<>(1, new CompareProcessPriority());
...
class CompareProcessPriority implements Comparator<Process> {
    public int compare(Process p1, Process p2) {
        ...
        // Process 1 priority == Process 2 priority
        return 0;
    }
}
